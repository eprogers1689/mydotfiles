...
export RamseyProjectList="('ACCH','AUTO','BS','CE','CIAM','CME','CONPROD','CRM','CRMSD','DATA','DATAREQ','DNA','DT','EMAIL','ENTRE','ES','FPC','FWCRM','FWOPS','GW','HRIS','INNER','INT','IT','ITINFRA','ITOPS','JA','JIRA','LE','MM','MMT','MR','NETWORK','NS','NSD','OPT','PER','PHOTO','PJM','PM','PR','PROC','PRODUCT','PUB','RECRM','RMCRM','RPLUS','RSCOM','RSMOR','SD','SOCIAL','STAFF','STAFF2','STS','TEST','TOURS','TRAIN','TRUSTED','VIDEO','WS','ZDSK')"
