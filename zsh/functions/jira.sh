...
export RamseyProjectList="('ACCH','AN','ANREQ','AUTO','BS','CE','CIAM','CME','CONPROD','CONTRACT','CPT','CRM','CRMSD','DATA','DATAREQ','DEBIT','DNA','DT','ELPCRM','EMAIL','ENTRE','ES','ETP','ETP2','FPC','FWCRM','FWOPS','GW','HRIS','ICM','ID','IF','IMREQ','INNER','INT','INTRANET','IT','ITINFRA','ITOPS','JA','JIRA','JSD','JSDAPPR','LE','MARTECH','MM','MMT','MR', 'MULE','NETWORK','NS','NSD','OPT','PER','PHOTO','PHOTOREQ','PIT','PJM','PM','PR','PROC','PRODSETUP','PRODUCT','PTJ','PTM','PUB','PUBLICITY','RA','RECRM','REDA','RESO','RIH','RMCRM','RPLUS','RSCOM','RSMOR','SD','SDCC','SOCIAL','STAFF','STAFF2','STS','TBD','TBP','TEST','TOUR','TOUR2','TOURS','TPD','TRAIN','TRUSTED','VIDEO','WS','ZDSK')"
